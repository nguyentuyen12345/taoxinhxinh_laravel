        ...
        <div class="row ">
            ...
            <div class="col-md-7">
                <div class="bg-light right">
                    ...
                    <h2 class="price text-secondary"> <del>{{ number_format($product->compare_price, 0, '.', '.') }}đ</del></h2>
                    @endif
                ...
                <div class="bg-light">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            {{-- <button class="nav-link active" id="description-tab" data-bs-toggle="tab" data-bs-target="#description" type="button" role="tab" aria-controls="description" aria-selected="true">Miêu tả</button> --}}
                            <h3 class="mb-3">Miêu tả</h3>
                        </li>
                         </ul>
