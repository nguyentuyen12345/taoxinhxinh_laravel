            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-header">
                        <h2 class="h5 fw-bold mb-0 pt-2 pb-2">Thông tin cá nhân</h2>
                        ...
                        <div class="card-body p-4">
                            <div class="row">
                                <div class="mb-3">
                                    ...
                                    <input value="{{ $user->name }}" type="text" name="name" id="name" placeholder="Nhập tên" class="form-control">
                                    <p></p>
                                </div>
                                <div class="mb-3">
                                    <label for="email">Email</label>
                                    <input  value="{{ $user->email }}"  type="text" name="email" id="email" placeholder="Nhập Email của bạn" class="form-control">
                                    <p></p>
                                </div>
                                <div class="mb-3">
                        ...
                        <div class="card-body p-4">
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="name">Tên</label>
                                    <input value="{{ (!empty($address)) ? $address->first_name : '' }}" type="text" name="first_name" id="first_name" placeholder="Nhập tên" class="form-control">
                                    <p></p>
                                </div>
                                <div class="col-md-6  mb-3">
                                    <label for="name">Họ tên</label>
                                    <input value="{{ (!empty($address)) ? $address->last_name : '' }}" type="text" name="last_name" id="last_name" placeholder="Nhập họ và tên" class="form-control">
                                    <p></p>
                                </div>
                                <div class="col-md-6  mb-3">
                                    <label for="email">Email</label>
                                    <input  value="{{ (!empty($address)) ? $address->email : '' }}"  type="text" name="email" id="email" placeholder="Nhập Email của bạn" class="form-control">
                                    <p></p>
                                </div>
                                <div class="col-md-6  mb-3">
