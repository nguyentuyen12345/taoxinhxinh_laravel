            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-header">
                        <h2 class="h5 mb-0 pt-2 pb-2">Đặt hàng: {{ $order->id }}</h2>
                    </div>
                            ...
                            <div class="card-body bg-light mb-3">
                                <div class="row">
                                    <div class="col-6 col-lg-3">
                                        <!-- Heading -->
                                        <h6 class="heading-xxxs text-muted">Không đặt hàng:</h6>
                                        <!-- Text -->
                                    ...
                                    <div class="col-6 col-lg-3">
                                        <!-- Heading -->
                                        <h6 class="heading-xxxs text-muted">Số lượng đặt hàng:</h6>
                                        <!-- Text -->
                                        <p class="mb-0 fs-sm fw-bold">
                    ...
                    <div class="card-footer p-3">
                        ...
                        <!-- Heading -->
                        <h6 class="mb-7 h5 mt-4">Đặt hàng ({{ $orderItemsCount }})</h6>
