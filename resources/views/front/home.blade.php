...
<style>.section-3 .row {
    display: flex; /* Sử dụng Flexbox để đảm bảo các mục nằm trên một hàng */
    flex-wrap: wrap; /* Cho phép phần tử chảy xuống khi không đủ chỗ */
    gap: 20px; /* Khoảng cách giữa các cột */
}

.section-3 .col-lg-3 {
    flex: 1 1 calc(20% - 20px); /* Điều chỉnh chiều rộng để có 5 cột trong mỗi hàng */
    max-width: calc(20% - 20px); /* Đảm bảo rằng mỗi cột không vượt quá 20% chiều rộng */
    box-sizing: border-box; /* Đảm bảo rằng padding và border không ảnh hưởng đến tổng chiều rộng */
}
</style>
