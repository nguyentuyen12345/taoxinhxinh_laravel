		...
		<div class="row align-items-center py-3 d-none d-lg-flex justify-content-between">
			<div class="col-lg-4 logo">
				<a href="index.php" class="text-decoration-none">
					<span class="h1 text-uppercase text-primary bg-dark px-2">ILux</span>
					<span class="h1 text-uppercase text-dark bg-primary px-2 ml-n1">Store</span>
				</a>
			</div>
			<div class="col-lg-6 col-6 text-left  d-flex justify-content-end align-items-center">
				<a href="account.php" class="nav-link text-dark">Tài khoản</a>
				<form action="">
					<div class="input-group">
						<input type="text" placeholder="Tìm kiếm sản phẩm" class="form-control" aria-label="Amount (to the nearest dollar)">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 ">
                    <div class="box shadow-lg">
                        ...
                        <h2 class="font-weight-semi-bold m-0">Hỗ trợ 24/24</h5>
                    </div>
                </div>
            </div>
        </div>
		...
		<div class="row">
			<div class="col-md-4">
				<div class="footer-card">
					<h3> Thông tin</h3>
					   <ul>
						<li><a href="about-us.php" title="About">Tin tức</a></li>
						<li><a href="contact-us.php" title="Contact Us">Giới thiệu</a></li>
						<li><a href="#" title="Privacy">Bảo hành và sữa chữa</a></li>
						<li><a href="#" title="Privacy">Đánh giá chất lượng và khiếu nại</a></li>
			...
			<div class="col-md-4">
				<div class="footer-card">
					<h3>Chính sách</h3>
					<ul>
						<li><a href="about-us.php" title="About">Đổi trả</a></li>
						<li><a href="contact-us.php" title="Contact Us">Giao hàng</a></li>
						<li><a href="#" title="Privacy">Bảo hành</a></li>
						<li><a href="#" title="Privacy">Đổi trả</a></li>
			...
			<div class="col-md-4">
				<div class="footer-card">
					...
					<ul>
						<li><a href="#" title="Sell">Tài khoản của tôi</a></li>
						<li><a href="#" title="Advertise"> Địa chỉ liên hệ: khóm 1 phường 7 thành phố trà vinh</a></li>
						<li><a href="#" title="Contact Us">Số điện thoại: 0528358715</a></li>
					</ul>
