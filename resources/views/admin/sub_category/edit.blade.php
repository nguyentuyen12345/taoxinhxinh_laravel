            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="status">Hiển thị trang chủ</label>
                                <select name="showHome" id="showHome" class="form-control">
                                    <option {{ ($subCategory->showHome == 'Yes') ? 'selected' : '' }}  value="Yes">Có</option>
                                    <option {{ ($subCategory->showHome == 'No') ? 'selected' : '' }}  value="No">Không</option>
                                </select>
                            </div>
                        </div>
                    </div>
