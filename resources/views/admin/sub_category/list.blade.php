    ...
    <div class="container-fluid my-2">
        <div class="row mb-2">
            ...
            <div class="col-sm-6 text-right">
                <a href="{{ route('sub-categories.create') }}" class="btn btn-primary">Tạo mới danh mục con</a>
            </div>
        </div>
    </div>
    <!-- /.container-fluid -->
        ...
        <div class="card">
            ...
            <div class="card-header">
                <div class="card-title">
                    <button type="button" onclick="window.location.href='{{ route("sub-categories.index") }}'" class="btn btn-default btn-sm">Tải lại</button>
                </div>
