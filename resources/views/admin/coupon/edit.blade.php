...
<section class="content-header">
    <div class="container-fluid my-2">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Chỉnh sửa mã phiếu giảm giá</h1>
            </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select name="type" id="type" class="form-control">
                                    <option {{ ($coupon->type == 'percent') ? 'selected' : '' }} value="percent">%</option>
                                    <option {{ ($coupon->type == 'fixed') ? 'selected' : '' }} value="fixed">Đã sửa</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select name="status" id="status" class="form-control">
                                    ...
                                    <option  {{ ($coupon->status == 0) ? 'selected' : '' }}  value="0">Ẩn</option>
                                </select>
                            </div>
                        </div>
