            ...
            <form action="" method="get">
                <div class="card-header">
                    <div class="card-title">
                        <button type="button" onclick="window.location.href='{{ route("products.index") }}'" class="btn btn-default btn-sm">Tại lại trang</button>
                    </div>
                    ...
                    <tbody>
                        @if ($products->isNotEmpty())
                            ...
                            <tr>
                                ...
                                <td>${{ $product->price }}</td>
                                <td>{{ $product->qty }} còn hàng trong kho</td>
                                <td>{{ $product->sku }}</td>
                                <td>
                                    @if ($product->status == 1)
